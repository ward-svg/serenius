...
export default function AddContactPanel({
  ...
  return (
    <SereniusModal
      title="Add Contact"
      description={`Add a related contact for ${partner.display_name}.`}
      onClose={onClose}
      footer={
        <>
      ...
      <form id="add-contact-form" onSubmit={handleSubmit}>
          ...
          <div className="form-group">
            ...
            >
              ...
              <select
                ...
                onChange={(e) =>
                  handleChange("primary_phone_type", e.target.value)
                }
              >
                <option value="">Select...</option>
                {PHONE_TYPES.map((o) => (
          ...
          <div className="form-group">
            ...
            >
              ...
              <select
                ...
                onChange={(e) =>
                  handleChange("secondary_phone_type", e.target.value)
                }
              >
                <option value="">Select...</option>
                {PHONE_TYPES.map((o) => (
        ...
        >
          <input
            ...
            onChange={(e) =>
              handleChange("display_financial_data", e.target.checked)
            }
            style={{
        ...
        >
          <input
            ...
            onChange={(e) =>
              handleChange("clone_primary_address", e.target.checked)
            }
            style={{
              accentColor: "var(--brand-primary)",
              width: 15,
            ...
            <div className="form-row full">
              <div className="form-group">
                ...
                <input
                  ...
                  onChange={(e) =>
                    handleChange("address_street2", e.target.value)
                  }
                />
              </div>
            </div>
